...
class UserProfiler:
    ...
    def create_llm_prompt(self, user_summary: str) -> str:
        prompt = f"""Based on this purchase history, summarize this person's genuine preferences and 
...
if __name__ == "__main__":
    ...
    analyses = profiler.analyze_users(test_users, summary_dir="user_summaries_vanilla_m")
